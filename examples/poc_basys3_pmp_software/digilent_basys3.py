...
class BaseSoC(SoCCore):
    def __init__(self, sys_clk_freq=int(75e6), with_led_chaser=True, with_video_terminal=False, **kwargs):
        ...
        # CPU fault PoC
        injector_signals = [ self.cpu.ibus.dat_r, self.cpu.ibus.adr]
        ...
        self.cpu.cpu_params["i_iBusWishbone_DAT_MISO"] = self.injector.o_ibus_dat_r

        # LiteScopeAnalyzer ------------------------------------------------------------------------
        analyzer_signals = [
            self.cpu.cpu_params["i_iBusWishbone_DAT_MISO"],
            self.cpu.cpu_params["o_iBusWishbone_ADR"],
        ...
        # Make sure you have added the serial port in the platform file.
